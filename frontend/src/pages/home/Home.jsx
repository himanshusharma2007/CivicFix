...
export default function Home() {
  ...
  const { issues, resolvedIssues, highSeverityIssues, loading } = useSelector((state) => state.issues);
  ...
  // Determine which issues to display based on filter
  const displayedIssues =
    filter === "resolved" ? resolvedIssues : filter === "high" ? highSeverityIssues : issues;
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 mt-auto">
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-sm border border-gray-200 text-gray-700 py-2 rounded-lg hover:bg-gray-100 transition duration-150"
                    >
                      View Details
                    </button>
                  </div>
